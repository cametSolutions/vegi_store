        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="bg-white p-4 rounded-sm border border-slate-200 shadow-sm space-y-4">
            <div className="flex items-center gap-2 mb-2 pb-2 border-b border-slate-100">
              ...
              <span className="text-xs font-bold text-slate-700 uppercase tracking-wide">Financial Year</span>
            </div>
              ...
              <div className="space-y-2.5 mt-2">
                {[
                  ...
                  >
                    <input
                      type="radio"
                      {...register("financialYear.format", { required: "Financial year format is required" })}
                      value={option.value}
                    ...
                    />
                    <span className={`text-xs font-medium ${editData?.financialYear?.isLocked ? 'text-slate-400' : 'text-slate-700 group-hover:text-slate-900'}`}>
                      {option.label}
                    </span>
                  </label>
                ))}
              </div>
              {errors.financialYear?.format && <ErrorMessage message={errors.financialYear.format.message} />}
              ...
              {editData?.financialYear?.isLocked && (
                <div className="mt-3 p-2.5 bg-amber-50 border border-amber-200 rounded-md flex items-start gap-2">
                  ...
                  <p className="text-[10px] text-amber-700 font-medium leading-relaxed">
                    Financial year format is locked and cannot be changed after transactions are created.
                  </p>
                </div>
              )}
            </div>
