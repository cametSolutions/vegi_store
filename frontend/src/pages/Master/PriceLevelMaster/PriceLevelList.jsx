    ...
    <div className="flex flex-col w-full h-full">
      ...
      {!isError && (
        <div className="h-[calc(100vh-175px)] overflow-auto border bg-white shadow-md ">
          <table className="min-w-full  table-fixed border-none text-xs">
            <thead className="bg-slate-400 text-white sticky top-0 z-10">
              <tr>
                <th className="w-3/5 px-3 py-2 text-left">Price Level Name</th>
                <th className="w-1/5 px-3 py-2 text-left">Status</th>
                <th className="w-1/5 px-3 py-2 text-center">Actions</th>
              </tr>
            </thead>
            <tbody>
              {isLoading ? (
                <tr className="h-[calc(100vh-250px)]">
                ...
                filteredPriceLevels.map((pl) => (
                  ...
                  >
                    <td className="px-3 py-2 truncate">{pl.priceLevelName}</td>
