      ...
      <div className="grid grid-cols-4 gap-4 text-xs">
        ...
        <div className="flex items-center justify-between">
          ...
          <input
            ...
            className="w-22 px-1 py-0.5 border border-slate-300 rounded-xs text-right text-xs"
          />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <input
            ...
            className="w-26 px-1 py-0.5 border border-slate-300 rounded-xs text-right text-xs"
          />
        </div>
      </div>
    </div>
