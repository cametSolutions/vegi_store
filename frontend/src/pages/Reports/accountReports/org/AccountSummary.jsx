...
const AccountSummary = () => {
  ...
  const config = {
    ...
    // Keys to access data from the breakdown object
  ...
  const queryOptions = accountMasterQueries.getAccountStatement(
    ...
    companyId,
    branchId,
    null, // accountId is null to get all accounts
    transactionType, 
    currentPage,
    limit,
    debouncedSearchTerm,
    true // ✅ summaryOnly flag
  );
  ...
  const TableColGroup = () => (
    <colgroup>
      ...
      <col style={{ width: "250px" }} />  {/* Account Name */}
      <col style={{ width: "200px" }} />  {/* Email */}
      <col style={{ width: "150px" }} />  {/* phoneNo */}
      <col style={{ width: "150px" }} />  {/* Main Amount */}
      <col style={{ width: "150px" }} />  {/* Return Amount */}
    </colgroup>
  );
                ...
                <table className="w-full table-fixed border-collapse">
                  ...
                  <thead>
                    ...
                    <tr className="border-b border-slate-300">
                      ...
                      {/* Dynamic Header 1 (Main Transaction) */}
                      ...
                      {/* Dynamic Header 2 (Return Transaction) */}
                  ...
                  <tbody className="divide-y divide-slate-200 bg-white">
                    {summaryData.map((row, idx) => {
                      // Extract breakdown totals safely
                      ...
                      return (
                        <tr key={row.accountId} className="hover:bg-slate-50 transition-colors group">
                          ...
                          {/* Main Transaction Data (Sale/Purchase) */}
                          ...
                          {/* Return Transaction Data (Sales Return/Purchase Return) */}
